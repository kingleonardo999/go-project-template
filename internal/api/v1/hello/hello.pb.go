...
const file_hello_hello_proto_rawDesc = "" +
	"\n" +
	"\x11hello/hello.proto\x12\x05hello\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\x1e\n" +
	"\bHelloReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"%\n" +
	"\tHelloResp\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2Z\n" +
	"\fHelloService\x12J\n" +
	"\bSayHello\x12\x0f.hello.HelloReq\x1a\x10.hello.HelloResp\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/v1/hello/say-helloBd\n" +
	"\tcom.helloB\n" +
	"HelloProtoP\x01Z\x17agent/internal/v1/hello\xa2\x02\x03HXX\xaa\x02\x05Hello\xca\x02\x05Hello\xe2\x02\x11Hello\\GPBMetadata\xea\x02\x05Hellob\x06proto3"
